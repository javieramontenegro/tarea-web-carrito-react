                  ...
                  <div className="w-full h-auto flex gap-2">
                    ...
                    <div className="flow-root isolate">
                      ...
                      <div className="flex items-center gap-[5px] mb-4 isolate">
                        <button className="flex justify-center items-center w-[30px] h-[30px] bg-white border border-gray-300 rounded-[5px] text-center cursor-pointer cursor-grab">-</button>
                        <span>1</span>
                        <button className="flex justify-center items-center w-[30px] h-[30px] bg-white border border-gray-300 rounded-[5px] text-center cursor-pointer cursor-grab">+</button>
                      </div>
                      <p className="mt-1 mb-2 font-sans">$30.000 c/u x 1</p>
                      <p className="font-bold font-sans"><b>$30.000</b></p>
                    </div>
                  </div>
                  <button className="self-start border-0 bg-white cursor-pointer cursor-grab pt-[3px] pr-[5px] pb-[3px] pl-[5px] rounded-[5px]">X</button>
                </div>
    )
}
export default Card 